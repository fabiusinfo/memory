...
public:
	...
	virtual bool repairOneNeg(vector<Point3D> &p, vector<Element *> &e,
						unsigned int &nodeidx, Metric *metric, 
						unsigned int &max_iter, const double &threshold, int step, string type, map<int, list<int>> &neighborsmap) ;
