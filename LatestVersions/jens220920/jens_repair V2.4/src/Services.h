...
namespace Clobscode
{
	...
	class Services {
		...
		//-------------------------------------------------------------------
		//-------------------------------------------------------------------
		static bool ReadMdlMesh(std::string name, vector<Point3D> &tri_pts, vector<vector<unsigned int> > &allfaces,
								  vector<Clobscode::TriMesh> &clobs_inputs){
        ...
        //-------------------------------------------------------------------
        //-------------------------------------------------------------------
        static void NeighborgKnowlegde (std:: vector<Element *> &e, vector<Point3D> &p, map<int, list<int>> &neighborsmap ){
        	list<int>listNeighbors;
        	for (int i=0; i<p.size(); i++ ){
        		neighborsmap[i]= listNeighbors;
        	}
        	for (unsigned int i=0;i<e.size();i++){
        		vector<unsigned int> nodes = e[i]->getPoints();
        		if (nodes.size()==8){
        			//cout<<"es un Hexaedro"<<endl;

        	
        			neighborsmap.find(nodes[0])->second.push_back(nodes[1]);
        			neighborsmap.find(nodes[0])->second.push_back(nodes[3]);
        			neighborsmap.find(nodes[0])->second.push_back(nodes[4]);
        	
        			
        			neighborsmap.find(nodes[1])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[1])->second.push_back(nodes[2]);
        			neighborsmap.find(nodes[1])->second.push_back(nodes[5]);
        	
        			
        			neighborsmap.find(nodes[2])->second.push_back(nodes[1]);
        			neighborsmap.find(nodes[2])->second.push_back(nodes[3]);
        			neighborsmap.find(nodes[2])->second.push_back(nodes[6]);
        	
        			
        			neighborsmap.find(nodes[3])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[3])->second.push_back(nodes[2]);
        			neighborsmap.find(nodes[3])->second.push_back(nodes[7]);
        		
        			
        			neighborsmap.find(nodes[4])->second.push_back(nodes[5]);
        			neighborsmap.find(nodes[4])->second.push_back(nodes[7]);
        			neighborsmap.find(nodes[4])->second.push_back(nodes[0]);
        	
        			
        			neighborsmap.find(nodes[5])->second.push_back(nodes[4]);
        			neighborsmap.find(nodes[5])->second.push_back(nodes[6]);
        			neighborsmap.find(nodes[5])->second.push_back(nodes[1]);
        	
        			
        			neighborsmap.find(nodes[6])->second.push_back(nodes[5]);
        			neighborsmap.find(nodes[6])->second.push_back(nodes[7]);
        			neighborsmap.find(nodes[6])->second.push_back(nodes[2]);
      
        			
        			neighborsmap.find(nodes[7])->second.push_back(nodes[4]);
        			neighborsmap.find(nodes[7])->second.push_back(nodes[6]);
        			neighborsmap.find(nodes[7])->second.push_back(nodes[3]);
        		}else if (nodes.size()==4){
        			//cout<<"es un tetraedro"<<endl;
        			

        			neighborsmap.find(nodes[0])->second.push_back(nodes[1]);
        			neighborsmap.find(nodes[0])->second.push_back(nodes[2]);
        			neighborsmap.find(nodes[0])->second.push_back(nodes[3]);
        			

        			neighborsmap.find(nodes[1])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[1])->second.push_back(nodes[2]);
        			neighborsmap.find(nodes[1])->second.push_back(nodes[3]);
        			

        			neighborsmap.find(nodes[2])->second.push_back(nodes[1]);
        			neighborsmap.find(nodes[2])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[2])->second.push_back(nodes[3]);
        			

        			neighborsmap.find(nodes[3])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[3])->second.push_back(nodes[1]);
        			neighborsmap.find(nodes[3])->second.push_back(nodes[2]);
        		}else if (nodes.size()==5){
        			//cout<<"es una piramide"<<endl;
        			...
        			neighborsmap.find(nodes[1])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[1])->second.push_back(nodes[2]);
        			neighborsmap.find(nodes[1])->second.push_back(nodes[4]);
        			

        			neighborsmap.find(nodes[2])->second.push_back(nodes[1]);
        			neighborsmap.find(nodes[2])->second.push_back(nodes[3]);
        			neighborsmap.find(nodes[2])->second.push_back(nodes[4]);
        			

        			neighborsmap.find(nodes[3])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[3])->second.push_back(nodes[2]);
        			neighborsmap.find(nodes[3])->second.push_back(nodes[4]);
        			

        			neighborsmap.find(nodes[4])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[4])->second.push_back(nodes[1]);
        			neighborsmap.find(nodes[4])->second.push_back(nodes[2]);
        			neighborsmap.find(nodes[0])->second.push_back(nodes[3]);

        				
        		}else{
        			//cout<<"es un prisma"<<endl;	
        			...
        			neighborsmap.find(nodes[2])->second.push_back(nodes[1]);
        			neighborsmap.find(nodes[2])->second.push_back(nodes[0]);
        			neighborsmap.find(nodes[2])->second.push_back(nodes[5]);
        			

        			neighborsmap.find(nodes[3])->second.push_back(nodes[4]);
        			neighborsmap.find(nodes[3])->second.push_back(nodes[5]);
        			neighborsmap.find(nodes[3])->second.push_back(nodes[0]);
        			

        			neighborsmap.find(nodes[4])->second.push_back(nodes[3]);
        			neighborsmap.find(nodes[4])->second.push_back(nodes[5]);
        			neighborsmap.find(nodes[4])->second.push_back(nodes[1]);
        			

        			neighborsmap.find(nodes[5])->second.push_back(nodes[4]);
        			neighborsmap.find(nodes[5])->second.push_back(nodes[3]);
        			neighborsmap.find(nodes[5])->second.push_back(nodes[2]);
		...
		/*for (int i=0; i<p.size(); i++ ){
        		neighborsmap.find(i)->second.sort();
        		neighborsmap.find(i)->second.unique();
        		cout<<"largo de la lista de vecinos del nodo "<<neighborsmap.find(i)<<" es: "<<neighborsmap.find(i)->second.size()<<endl;
        	}*/
